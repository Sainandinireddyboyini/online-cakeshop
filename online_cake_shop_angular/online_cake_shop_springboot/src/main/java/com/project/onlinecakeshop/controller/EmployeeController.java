...
import com.project.onlinecakeshop.repository.EmployeeRepository;
...
public class EmployeeController {
	...
	public ArrayList getAllEmployeeFields() {
		 Query q = entityManager.createQuery("SELECT emp, cn, dn from employee emp, address cn, email dn  WHERE employee_email = email_id AND employee_address = email_id");
